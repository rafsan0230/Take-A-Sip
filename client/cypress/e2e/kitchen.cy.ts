...
describe('starting e2e for ordering', () => {
  it('Admin can view the latest order', () => {
    ...
    cy.get(':nth-child(2) > .mat-mdc-card > .mat-mdc-card-content > .mat-mdc-list > .mat-mdc-list-item > .mdc-list-item__content > .mat-mdc-list-item-title').should('contain', "MILK")
  });
});
